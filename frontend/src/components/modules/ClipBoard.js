      ...
      <div className="container">
        ...
        <div className="row gap-3">
          <input
            ...
            className="col-md-8"
            name="inpTxt"
            onChange={this.inpTxtHandler}
            value={this.state.inpTxt}
            placeholder="Enter something you want to keep on clipbord"
          />
          <button className="col-sm btn-grad" onClick={this.addClips}>
            Add
          </button>
          <button
            className="col-sm btn-grad btn-grad-red"
        ...
        <div className="row my-3">
          ...
          {this.state.clipList.length === 0 ? (
            <h3 className="text-center">No clips added</h3>
          ) : (
