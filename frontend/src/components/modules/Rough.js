            ...
            <div>
                <div className='container container-fluid'>
                    <div className='row my-3 justify-content-space-between'>
                        ...
                        <button className="col-md-3 btn btn-success" data-bs-toggle="collapse" data-bs-target="#opContent">Operations <Icon.CaretRightFill className='arrow' /></button>
                    </div>
                    <div className='collapse navbar-collapse' id='opContent'>
                        <div className='row mb-3 gap-2'>
                            <button className='col btn btn-success'>Remove nbsp</button>
                            <button className='col btn btn-success'>Create Reference</button>
                            <button className='col btn btn-success'>Create Bullet point</button>
                        </div>
                        <div className="row mb-3 gap-2">
                            <input type="text" className='col-md-8' placeholder='Enter the html tag to be removed eg: sup' name="rmtag" id="" />
                            <button className='col btn btn-success'>Remove tags</button>
                        </div>
                        <div className="row mb-3 gap-2">
                            ...
                            <button className='col-md btn btn-success'>Replace String</button>
                        </div>
                    </div>
                </div>
            </div>
